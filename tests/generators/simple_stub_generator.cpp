...
namespace {
    ...
    class SimpleStub : public Halide::Generator<SimpleStub> {
        ...
        public:
            GeneratorParam<Type> func_input_type{ "func_input_type", Float(32) };
        ...
        public:
            ...
            Input<Func> func_input{ "func_input", Float(32), 2 };  // require a 2-dimensional Func but leave Type unspecified
        ...
        public:
            void generate() {
                simple_output(x, y) = cast<float>(cast(func_input_type, func_input(x, y)) +
                                                  offset +
                                                  buffer_input(x, y)) + float_arg;
            }
